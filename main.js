...
},{"./SVGElementSC":4,"./globalsSC":7}],4:[function(require,module,exports){
let globals = require('./globalsSC');
const SVG_NS = globals.SVG_NS;
class SVGElementSC{
    constructor(parent){
...
},{"./globalsSC":7}],5:[function(require,module,exports){
let globals = require('./globalsSC');
const SVGElementSC = require('./SVGElementSC');
...
},{"./SVGElementSC":4,"./globalsSC":7}],6:[function(require,module,exports){
...
module.exports = App;
},{"./Exporter":2,"./PotentiometerManager":3,"./ServoMotor":5,"./globalsSC":7,"dat.gui":1}],7:[function(require,module,exports){
const mmppx = 3.7796;
